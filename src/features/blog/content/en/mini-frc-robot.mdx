...
description: 'My first makerspace project: attempting to build a robot using old FRC components.'
pubDate: 2023-10-04
heroImage:
...
isDraft: false
featured: true
relatedPosts: ['en/horizon-driving', 'en/pcb-fabrication', 'en/retro-bluetooth-controller', 'en/beanbot']
---
