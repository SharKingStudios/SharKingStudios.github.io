...
pubDate: 2025-11-25
heroImage:
  url: '../../../..//assets/carkit/CarKit Blog Banner.png'
  alt: 'CarKit Banner'
tags: ['Hack Club', 'Electronics', 'Senior Year']
difficulty: 'intermediate'
isDraft: false
featured: false
relatedPosts: ['en/guardrail-fc', 'en/yuzu-pocket', 'en/nif-t']
---
...
_(You bring the chassis. It brings the brains.)_
...
<Gallery
  images={[{ src: '/assets/carkit/sidePCBRender.png', alt: 'Side PCB Render' }]}
/>
<Gallery
  images={[{ src: '/assets/carkit/topPCBRender.png', alt: 'Top PCB Render' }]}
/>
<Gallery
  images={[
...
- **2 DC motors with PWM** (think: _drive_ + _steering/turning_)
...
The full open-source project lives **[here](https://github.com/SharKingStudios/carkit)**.
...
Because every DIY RC build uses a _different_ battery, obviously.

- **USB-C (5 V)**
  - For bench testing, firmware dev, and flexing modern ports
- **Barrel jack**
  - Perfect for _9 V batteries_ or standard DC wall adapters
- **Screw terminals**
  - Bring your own LiPo / battery pack

_(Don't feed the board anything over 36V, I would recommend staying under 24V)_
...
_(You can map “A” to beep the buzzer. You absolutely should.)_
...
- Some motors
- A pile of batteries
- And zero desire to reinvent **“basic motor control + power + Bluetooth”** _again_
