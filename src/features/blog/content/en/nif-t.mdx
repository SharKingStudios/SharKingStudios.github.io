...
pubDate: 2025-12-20
heroImage:
  url: '../../../..//assets/nif-t/Nif-T Blog Banner.png'
  alt: 'Nif-T Banner'
tags: ['Hack Club', 'Electronics', 'Senior Year']
difficulty: 'advanced'
isDraft: false
featured: false
relatedPosts: ['en/guardrail-fc', 'en/yuzu-pocket', 'en/carkit']
---
...
<Gallery
  images={[{ src: '/assets/nif-t/sidePCBRender.png', alt: 'Side PCB Render' }]}
/>
<Gallery
  images={[{ src: '/assets/nif-t/topPCBRender.png', alt: 'Top PCB Render' }]}
/>
<Gallery
  images={[
...
<Gallery
  images={[{ src: '/assets/nif-t/PCBRender.png', alt: 'Routing Glamour Shot' }]}
/>
<Gallery
  images={[
...
> _The middle ground planes are hidden in the PCB Routing render_

---

## Project Files

The full open-source project lives **[here](https://github.com/SharKingStudios/Nif-T)**.
...
> _“Hey Google, turn on the big light.”_
...
_(Please don’t hot-switch mains unless you know what you’re doing.)_
...
_(See schematic for full pin mapping and signal names.)_
...
4. It connects to:
   - An _MQTT broker_ (usually Home Assistant)
5. Home Assistant:
...
- And sometimes you just want a _solid, hackable, relay board_ that plays nicely with modern home automation
