...
lang: 'en'
title: 'Yuzu Pocket'
description: 'A PCB business card that runs Linux and turns a USB port into a tiny portfolio computer.'
pubDate: 2026-06-13
heroImage:
  url: '../../../../assets/yuzu-pocket/Yuzu Pocket Thumbnail.png'
  alt: 'Yuzu Pocket front PCB render'
tags: ['Hack Club', 'Electronics']
difficulty: 'advanced'
isDraft: false
featured: false
relatedPosts: ['en/guardrail-fc', 'en/nif-t', 'en/carkit']
---
...
<Gallery
  images={[
    { src: '/assets/yuzu-pocket/Yuzu Pocket Side.png', alt: 'Side PCB Render' },
  ]}
/>
<Gallery
  images={[
    { src: '/assets/yuzu-pocket/Yuzu Pocket Front.png', alt: 'Top PCB Render' },
  ]}
/>
<Gallery
  images={[
    { src: '/assets/yuzu-pocket/Yuzu Pocket Back.png', alt: 'Back PCB Render' },
  ]}
/>
<Gallery
  images={[
    {
      src: '/assets/yuzu-pocket/copper front.png',
      alt: 'Routing Glamour Shot',
    },
    { src: '/assets/yuzu-pocket/schematic.png', alt: 'Schematic Picture' },
  ]}
/>
<Gallery
  images={[
    {
      src: '/assets/yuzu-pocket/Yuzu Pocket Zine Poster.png',
      alt: 'Zine Page!',
    },
  ]}
/>
...
The full open-source project lives **[here](https://github.com/SharKingStudios/Yuzu-Pocket)**.

---

## BOM

All the processors and storage sit **[here](https://github.com/SharKingStudios/Yuzu-Pocket/blob/main/BOM.csv)**.
...
2. The V3LP boots **U-Boot and Linux**
3. Linux creates a composite USB gadget containing:
   - A small read-only help drive
   - A USB network interface
   - A serial interface
4. The host receives an address on the private USB network
5. The card advertises itself as **`loganpeterson.local`**
6. Opening the included shortcut launches a browser-based terminal
7. The visitor is now using a Linux computer that's the size of a business card
...
| microSD                 |   Card dependent | Development, recovery, larger Linux images, and _experiments_ |
...
Firmware lives in **[`Firmware/`](https://github.com/SharKingStudios/Yuzu-Pocket/tree/main/Firmware)** and is organized as a Buildroot external tree.
...
See the **[firmware README](https://github.com/SharKingStudios/Yuzu-Pocket/blob/main/Firmware/README.md)** for build commands, image layout, and current implementation details.
...
> There is an integration point reserved for [`p2r3/bareiron`](https://github.com/p2r3/bareiron), a compact C Minecraft server experiment. It is not enabled by default yet because upstream requires generated Minecraft registry data before compilation (and I haven't gotten to that).
