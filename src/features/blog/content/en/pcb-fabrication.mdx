...
isDraft: false
featured: true
relatedPosts: ['en/horizon-driving', 'en/retro-bluetooth-controller', 'en/beanbot', 'en/mini-frc-robot']
---
...
I will continue to use PCB design software like it for (I think) a very long time.
