...
isDraft: true
featured: false
relatedPosts: ['en/guardrail-fc', 'en/nif-t', 'en/carkit', 'en/pcb-fabrication']
---
...
The full open-source project lives **[here](https://github.com/SharKingStudios/Tadpole-FPV)**.
...
<Gallery
  images={[
    {
      src: '/assets/tadpoleFPV/FPVTransmitterHardwareTable01.png',
      alt: 'FPV Transmitter Hardware Table (WIP)',
    },
  ]}
/>
...
<Gallery
  images={[
    {
      src: '/assets/tadpoleFPV/FPVTransmitterHardwareTable02.png',
      alt: 'FPV Transmitter Hardware Table (Final)',
    },
  ]}
/>
...
<Gallery
  images={[
    {
      src: '/assets/tadpoleFPV/DroneTransmitterElectronicsMockup.png',
      alt: 'Drone Transmitter Electronics Mockup',
    },
  ]}
/>
...
<Gallery
  images={[
    {
      src: '/assets/tadpoleFPV/transmissionschematic.png',
      alt: 'Transmission Schematic',
    },
  ]}
/>
...
<Gallery
  images={[
    {
      src: '/assets/tadpoleFPV/firstfootprints2.png',
      alt: 'Footprint updates',
    },
  ]}
/>
...
I also went through and added a footprint for each of the components in the schematic that didn't already have one.

<Gallery
  images={[
    {
      src: '/assets/tadpoleFPV/footprintupdates.png',
      alt: 'Footprint Updates',
    },
  ]}
/>

> _No harm in double checking the footprints, right?_

<Gallery
  images={[
    {
      src: '/assets/tadpoleFPV/physicallyprintedfootprints.jpg',
      alt: 'Physically printed footprints',
    },
  ]}
/>
...
<Gallery
  images={[
    {
      src: '/assets/tadpoleFPV/BuckBoostConverterSchematic.png',
      alt: 'Buck Boost Converter Schematic',
    },
  ]}
/>
...
<Gallery
  images={[
    {
      src: '/assets/tadpoleFPV/finishedlayout.png',
      alt: 'Finished PCB Layout',
    },
  ]}
/>

With all the components in place, I started wiring the traces of the board.  
This process was made harder by my incessant love of thicker traces, and close component positions.

> _Now this is my kind of puzzle_

I used .4mm traces for a majority of the board leading to this quite _mesmerising_ power section routing:

<Gallery
  images={[
    {
      src: '/assets/tadpoleFPV/finishedpowersectionrouting.png',
      alt: 'Finished Power Section Routing',
    },
  ]}
/>
...
<Gallery
  images={[
    {
      src: '/assets/tadpoleFPV/boardfrontfinishedlayout.png',
      alt: 'Finished PCB Layout View Front',
    },
    {
      src: '/assets/tadpoleFPV/boardbackfinishedlayout.png',
      alt: 'Finished PCB Layout View Back',
    },
    {
      src: '/assets/tadpoleFPV/finishedrouting.png',
      alt: 'Finished PCB Routing',
    },
  ]}
/>
...
<Gallery
  images={[
    ...
    {
      src: '/assets/tadpoleFPV/pcbroutingwithart.png',
      alt: 'PCB Routing with Art',
    },
  ]}
/>
